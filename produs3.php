...
<div class="col-6" >
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img src="img/sase.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="img/sapte.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
  ...
  <div class="col-5 align-self-center mx-0 my-auto">
    <div class="card-body card text-center my-auto mx-auto ">
      <h3 class="card-title ComicMS">COFFEE + MILK </h3>
      <p class="card-text ComicMS"><i>$7.99</i></p>
        <h4 class="card-title ComicMS">Taste notes </h4>
        <img src="img/opt.png" width="500" height="220" />
        <h4 class="card-title ComicMS">Ingredients </h4>
          <p class="card-text ComicMS"><i>Cocoa butter, organic cane sugar, Icelandic milk powder, coffee beans & sunflower lecithin.</i></p>
